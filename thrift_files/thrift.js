...
Thrift.TXHRTransport.prototype = {
    ...
    flush: function(async, callback) {
        ...
        if (xreq.overrideMimeType) {
            xreq.overrideMimeType('application/vnd.apache.thrift_files.json; charset=utf-8');
        }
        ...
        if (xreq.setRequestHeader) {
            xreq.setRequestHeader('Accept', 'application/vnd.apache.thrift_files.json; charset=utf-8');
            xreq.setRequestHeader('Content-Type', 'application/vnd.apache.thrift_files.json; charset=utf-8');
        }
    ...
    jqRequest: function(client, postData, args, recv_method) {
        ...
        var jqXHR = jQuery.ajax({
            ...
            type: 'POST',
            cache: false,
            contentType: 'application/vnd.apache.thrift_files.json; charset=utf-8',
...
Thrift.Protocol.prototype = {
    ...
    readMessageBegin: function() {
        ...
        if (version != Thrift.Protocol.Version) {
            throw 'Wrong thrift_files protocol version: ' + version;
        }
